...
#if !(DOXYGEN || GL_EXCEPTIONS_DISABLED)
...
#if !(defined(GL_DLL) || defined(GL_DLL_BUILD))
    GL_DECLARE_NON_COPYABLE(HeapBlock)
    GL_PREVENT_HEAP_ALLOCATION // Creating a 'new HeapBlock' would be missing the point!
#endif
};
