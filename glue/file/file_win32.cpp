...
namespace fs
{
    ...
    File::~File()
    {
        if (m_fileInfo) { delete (WIN32_FILE_ATTRIBUTE_DATA*) m_fileInfo; }
    }
    ...
    bool File::remove()
    {
        ...
        // Delete file
        if (!DeleteFileA(m_path.c_str())) { return false; }
    ...
    bool File::createDirectory()
    {
        ...
        // Create directory
        if (!CreateDirectoryA(m_path.c_str(), nullptr)) { return false; }
    ...
    bool File::removeDirectory()
    {
        ...
        // Remove directory
        if (!RemoveDirectoryA(m_path.c_str())) { return false; }
