...
// CORE_EXPORTS symbol defined on the command line. this symbol should not
// be defined on any project that uses this DLL. This way any other project
// whose source files include this file see CORE_API functions as being
...
//
    ...
    #if !defined(GL_NO_AUTOMATIC_LIBS) && !defined(CORE_EXPORTS)
