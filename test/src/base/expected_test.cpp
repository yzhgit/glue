...
TEST_CASE("expected::expected()") {
    ...
    SECTION("Default-constructs underlying type T") { REQUIRE(t.has_value()); }
}
...
TEST_CASE("expected::expected( const expected& )") {
    SECTION("Contains Value") {
        ...
        SECTION("Copy contains same value") { REQUIRE(*copy == *t); }
        SECTION("Calls underlying value's copy constructor") {
            // TODO: Check that the copy constructor is called
        }
        SECTION("Copied expected contains a value") { REQUIRE(copy.has_value()); }
    }
    ...
    SECTION("Contains Error") {
        ...
        SECTION("Copy contains same error") { REQUIRE(copy.error() == t.error()); }
        SECTION("Calls underlying error's copy constructor") {
            // TODO: Check that the copy constructor is called
        }
        SECTION("Copied expected contains an error") { REQUIRE(copy.has_error()); }
    }
...
TEST_CASE("expected::expected( expected&& )") {
    SECTION("Contains Value") {
        ...
        SECTION("Copy contains same value") { REQUIRE(*copy == *move); }
        SECTION("Calls underlying value's move constructor") {
            // TODO: Check that the move constructor is called
        }
        SECTION("Moved expected contains a value") { REQUIRE(move.has_value()); }
    }
    ...
    SECTION("Contains Error") {
        ...
        SECTION("Copy contains same error") { REQUIRE(copy.error() == move.error()); }
        SECTION("Calls underlying error's move constructor") {
            // TODO Check that the move constructor is called
        }
        SECTION("Moved expected contains an error") { REQUIRE(move.has_error()); }
    }
