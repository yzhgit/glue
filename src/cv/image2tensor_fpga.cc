...
void bgr_to_tensor_hwc(const uint8_t *src, paddle::zynqmp::float16 *output,
                       ImageFormat srcFormat, ImageFormat dstFormat, int srcw,
                       int srch, int dstw, int dsth, float *means,
                       float *scales);
 ...
 */
void Image2TensorFpga::choose(const uint8_t *src, Tensor *dst,
                              ImageFormat srcFormat, ImageFormat dstFormat,
                              LayoutType layout, int srcw, int srch, int dstw,
                              int dsth, float *means, float *scales) {
    ...
    impl_(src, output, srcFormat, dstFormat, srcw, srch, dstw, dsth, means,
          scales);
}
