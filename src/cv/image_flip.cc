...
{
    if (srcFormat == GRAY) { flip_hwc1(src, dst, srcw, srch, flip_param); }
...
{
    if (flip_param == X) { flip_hwc1_x(src, dst, srcw, srch); }
...
{
    if (flip_param == X) { flip_hwc3_x(src, dst, srcw, srch); }
    else if (flip_param == Y)
    {
...
{
    if (flip_param == X) { flip_hwc4_x(src, dst, srcw, srch); }
    else if (flip_param == Y)
    {
...
void flip_hwc1_x(const uint8_t* src, uint8_t* dst, int w_in, int h_in)
{
    ...
    LITE_PARALLEL_COMMON_BEGIN(i, tid, h_in, 0, 4)
    {
        ...
        {
#ifdef __aarch64__
            asm volatile("ld1  {v0.8b}, [%[inptr0]], #8    \n"  // v0={00,01,02, 03, 04,
                                                                // 05, 06, 07}"
                         "ld1  {v1.8b}, [%[inptr1]], #8     \n" // v0={10,11,12, 13, 14,
                                                                // 15, 16, 17}"
                         "ld1  {v2.8b}, [%[inptr2]], #8    \n"  // v0={20,21,22, 23, 24,
...
#else
            asm volatile("vld1.8  {d0}, [%[inptr0]]!   @ zip load r0, d0 =00 01 02 03 "
                         "04 05 "
                         "06 07\n"
                         "vld1.8  {d4}, [%[inptr1]]!   @ zip load r1, d2 =10 11 12 13 "
                         "14 15 "
                         "16 17\n"
                         "vld1.8  {d8}, [%[inptr2]]!   @ zip load r1, d4 =20 21 22 23 "
                         "24 25 "
                         "26 27\n"
                         "vld1.8  {d12}, [%[inptr3]]!   @ zip load r1, d6 = 30 31 32 33 "
                         "34 35 "
                         "36 37\n"
                         ...
                         "vst1.32  {d0},    [%[outptr0]]!   @ write d0(q0,low),r00,r10 "
                         "20 30\n"
                         "vst1.32  {d4},    [%[outptr1]]!   @ write d4(q0,low),r01,r11 "
                         "21 31\n"
                         "vst1.32  {d8},    [%[outptr2]]!   @ write d4(q0,low),r01,r11 "
                         "21 31\n"
                         "vst1.32  {d12},    [%[outptr3]]!   @ write d4(q0,low),r01,r11 "
                         "21 "
                         "31\n"
...
#else
            asm volatile(
                "vld1.8  {d0}, [%[inptr0]]!   @ zip load r0, d0 =00 01 02 03 "
                "04 05 "
                "06 07\n"
                "vld1.8  {d4}, [%[inptr1]]!   @ zip load r1, d2 =10 11 12 13 "
                "14 15 "
                ...
                "vrev64.8  d1, d0               @ reverse 07 06 05 04 03 02 01 "
                "00 \n"
                "vrev64.8  d5, d4              @ reverse 07 06 05 04 03 02 01 "
                "00 \n"
                "vrev64.8  d9, d8               @ reverse 07 06 05 04 03 02 01 "
                "00 \n"
                "vrev64.8  d13, d12               @ reverse 07 06 05 04 03 02 "
                "01 00 "
                "\n"
                "pld [%[inptr0]]                         @ preload a, 64byte\n"
                "pld [%[inptr1]]                         @ preload a, 64byte\n"
                "pld [%[inptr2]]                         @ preload a, 64byte\n"
                "pld [%[inptr3]]                         @ preload a, 64byte\n"
                "vst1.32  {d1},    [%[outptr0]]   @ write d0(q0,low),r00,r10 "
                "20 30\n"
                "vst1.32  {d5},    [%[outptr1]]   @ write d4(q0,low),r01,r11 "
                "21 31\n"
                "vst1.32  {d9},    [%[outptr2]]   @ write d4(q0,low),r01,r11 "
                "21 31\n"
                "vst1.32  {d13},    [%[outptr3]]   @ write d4(q0,low),r01,r11 "
                "21 31\n"
...
#else
            asm volatile("vld3.8  {d0, d1, d2}, [%[inptr0]]!   @ zip load r0, d0 =00 01 "
                         "02 03 "
                         "04 05 06 07\n"
                         "vld3.8  {d3, d4, d5}, [%[inptr1]]!   @ zip load r1, d2 =10 11 "
                         "12 13 "
                         "14 15 16 17\n"
                         "vld3.8  {d6, d7, d8}, [%[inptr2]]!   @ zip load r1, d4 =20 21 "
                         "22 23 "
                         "24 25 26 27\n"
                         "vld3.8  {d9, d10, d11}, [%[inptr3]]!   @ zip load r1, d6 = 30 "
                         "31 32 "
                         "33 34 35 36 37\n"
                         ...
                         "pld [%[inptr2]]                         @ preload a, 64byte\n"
                         "pld [%[inptr3]]                         @ preload a, 64byte\n"
                         "vst3.8  {d0, d1, d2},    [%[outptr0]]!   @ write "
                         "d0(q0,low),r00,r10 "
                         "20 30\n"
                         "vst3.8  {d3, d4, d5},    [%[outptr1]]!   @ write "
                         "d4(q0,low),r01,r11 "
                         "21 31\n"
                         "vst3.8  {d6, d7, d8},    [%[outptr2]]!   @ write "
                         "d4(q0,low),r01,r11 "
                         "21 31\n"
...
#else
            asm volatile(
                "vld3.8  {d0, d1, d2}, [%[inptr0]]!   @ zip load r0, d0 =00 01 "
                "02 03 "
                "04 05 06 07\n"
                "vld3.8  {d3, d4, d5}, [%[inptr1]]!   @ zip load r1, d2 =10 11 "
                "12 13 "
                ...
                "vrev64.8  d12, d0               @ reverse 07 06 05 04 03 02 "
                "01 00 \n"
                "vrev64.8  d13, d1               @ reverse 07 06 05 04 03 02 "
                "01 00 \n"
                "vrev64.8  d14, d2               @ reverse 07 06 05 04 03 02 "
                "01 00 \n"

                "vrev64.8  d15, d3               @ reverse 07 06 05 04 03 02 "
                "01 00 \n"
                "vrev64.8  d16, d4               @ reverse 07 06 05 04 03 02 "
                "01 00 \n"
                "vrev64.8  d17, d5               @ reverse 07 06 05 04 03 02 "
                "01 00 \n"

                "vrev64.8  d18, d6               @ reverse 07 06 05 04 03 02 "
                "01 00 \n"
                "vrev64.8  d19, d7               @ reverse 07 06 05 04 03 02 "
                "01 00 \n"
                "vrev64.8  d20, d8               @ reverse 07 06 05 04 03 02 "
                "01 00 \n"

                "vrev64.8  d21, d9               @ reverse 07 06 05 04 03 02 "
                "01 00 \n"
                "vrev64.8  d22, d10               @ reverse 07 06 05 04 03 02 "
                "01 00 "
                "\n"
                "vrev64.8  d23, d11               @ reverse 07 06 05 04 03 02 "
                "01 00 "
                "\n"
                "pld [%[inptr0]]                         @ preload a, 64byte\n"
                "pld [%[inptr1]]                         @ preload a, 64byte\n"
...
void flip_hwc4_x(const uint8_t* src, uint8_t* dst, int w_in, int h_in)
{
    ...
    LITE_PARALLEL_COMMON_BEGIN(i, tid, h_in, 0, 4)
    {
        ...
        {
#ifdef __aarch64__
            asm volatile("ld4  {v0.8b, v1.8b, v2.8b, v3.8b}, [%[inptr0]], #32  "
                         "  \n" // v0={00,01,02,
                                // 03,
                                // 04,
                                // 05,
                         ...
                         "          \n" // 02 12 22 32
                         "st4 {v8.8b, v9.8b, v10.8b, v11.8b}, [%[outptr2]], "
                         "#32             \n" // 01 11 21 31
                         "st4 {v12.8b, v13.8b, v14.8b, v15.8b}, [%[outptr3]], "
                         "#32             "
                         " \n" // 03 13 23 33
                         ...
                         : "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10", "v11",
                           "v12", "v13", "v14", "v15");
#else
            asm volatile("vld4.8  {d0, d1, d2, d3}, [%[inptr0]]!   @ zip load r0, d0 "
                         "=00 01 "
                         "02 03 04 05 06 07\n"
    ...
    LITE_PARALLEL_COMMON_BEGIN(i, tid, h_in, 0, 4)
    {
        ...
        for (; j < w_in - 7; j += 8)
        {
            ...
            asm volatile(
                ...
                "vrev64.8  d0, d8               @ reverse 07 06 05 04 03 02 01 "
                "00 "
                "\n"
                "vrev64.8  d1, d9               @ reverse 07 06 05 04 03 02 01 "
                "00 "
                "\n"
                "vrev64.8  d2, d10               @ reverse 07 06 05 04 03 02 "
                "01 00 "
                "\n"
                "vrev64.8  d3, d11               @ reverse 07 06 05 04 03 02 "
                "01 00 "
                "\n"

                "vrev64.8  d4, d12               @ reverse 07 06 05 04 03 02 "
                "01 00 "
                "\n"
                "vrev64.8  d5, d13               @ reverse 07 06 05 04 03 02 "
                "01 00 "
                "\n"
                "vrev64.8  d6, d14               @ reverse 07 06 05 04 03 02 "
                "01 00 "
                "\n"
                "vrev64.8  d7, d15               @ reverse 07 06 05 04 03 02 "
                "01 00 "
                "\n"
                "pld [%[inptr0]]                         @ preload a, 64byte\n"
                "pld [%[inptr1]]                         @ preload a, 64byte\n"
