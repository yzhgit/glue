 ...
 */
void SHA64_compress(uint64_t *digest, const uint8_t input[], size_t blocks) {
    ...
    for (size_t i = 0; i != blocks; ++i) {
        ...
        SHA2_64_F(A, B, C, D, E, F, G, H, W00, W14, W09, W01,
                  0x428A2F98D728AE22);
        SHA2_64_F(H, A, B, C, D, E, F, G, W01, W15, W10, W02,
                  0x7137449123EF65CD);
        SHA2_64_F(G, H, A, B, C, D, E, F, W02, W00, W11, W03,
                  0xB5C0FBCFEC4D3B2F);
        SHA2_64_F(F, G, H, A, B, C, D, E, W03, W01, W12, W04,
                  0xE9B5DBA58189DBBC);
        SHA2_64_F(E, F, G, H, A, B, C, D, W04, W02, W13, W05,
                  0x3956C25BF348B538);
        SHA2_64_F(D, E, F, G, H, A, B, C, W05, W03, W14, W06,
                  0x59F111F1B605D019);
        SHA2_64_F(C, D, E, F, G, H, A, B, W06, W04, W15, W07,
                  0x923F82A4AF194F9B);
        SHA2_64_F(B, C, D, E, F, G, H, A, W07, W05, W00, W08,
                  0xAB1C5ED5DA6D8118);
        SHA2_64_F(A, B, C, D, E, F, G, H, W08, W06, W01, W09,
                  0xD807AA98A3030242);
        SHA2_64_F(H, A, B, C, D, E, F, G, W09, W07, W02, W10,
                  0x12835B0145706FBE);
        SHA2_64_F(G, H, A, B, C, D, E, F, W10, W08, W03, W11,
                  0x243185BE4EE4B28C);
        SHA2_64_F(F, G, H, A, B, C, D, E, W11, W09, W04, W12,
                  0x550C7DC3D5FFB4E2);
        SHA2_64_F(E, F, G, H, A, B, C, D, W12, W10, W05, W13,
                  0x72BE5D74F27B896F);
        SHA2_64_F(D, E, F, G, H, A, B, C, W13, W11, W06, W14,
                  0x80DEB1FE3B1696B1);
        SHA2_64_F(C, D, E, F, G, H, A, B, W14, W12, W07, W15,
                  0x9BDC06A725C71235);
        SHA2_64_F(B, C, D, E, F, G, H, A, W15, W13, W08, W00,
                  0xC19BF174CF692694);
        SHA2_64_F(A, B, C, D, E, F, G, H, W00, W14, W09, W01,
                  0xE49B69C19EF14AD2);
        SHA2_64_F(H, A, B, C, D, E, F, G, W01, W15, W10, W02,
...
SHA_512::SHA_512()
    : m_buffer(BlockSize), m_digest(DigestSize / sizeof(uint64_t)) {
    clear();
}
...
void SHA_512::update(const uint8_t input[], size_t length) {
    m_count += length;
    ...
    const size_t full_blocks = length >> 7;
    ...
    buffer_insert(m_buffer, m_position, input + full_blocks * BlockSize,
                  remaining);
    m_position += remaining;
}

void SHA_512::final(uint8_t output[]) {
    clear_mem(&m_buffer[m_position], BlockSize - m_position);
    m_buffer[m_position] = 0x80;

    if (m_position >= BlockSize - 16) {
        compress_n(m_buffer.data(), 1);
        zeroise(m_buffer);
    }
     ...
     */
    store_be(m_count * 8, &m_buffer[BlockSize - 8]);

    compress_n(m_buffer.data(), 1);
    copy_out_vec_be(output, DigestSize, m_digest);
    clear();
}
