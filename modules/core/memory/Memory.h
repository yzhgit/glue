...
*/
#if GLUE_MSVC && (defined(GLUE_DLL) || defined(GLUE_DLL_BUILD)) &&                                 \
    !(GLUE_DISABLE_DLL_ALLOCATORS || DOXYGEN)

extern GLUE_API void* glueDLL_malloc(size_t);
extern GLUE_API void glueDLL_free(void*);
