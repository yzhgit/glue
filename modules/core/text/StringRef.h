...
/**
    ...
    @tags{Core}
*/
class GLUE_API StringRef final
{
public:
    ...
    */
    ...
    glue_wchar operator[](int index) const noexcept { return text[index]; }
...
#if GLUE_STRING_UTF_TYPE != 8 && !defined(DOXYGEN)
...
GLUE_API bool GLUE_CALLTYPE operator==(const String& string1, StringRef string2) noexcept;
/** Case-sensitive comparison of two strings. */
GLUE_API bool GLUE_CALLTYPE operator!=(const String& string1, StringRef string2) noexcept;
/** Case-sensitive comparison of two strings. */
GLUE_API bool GLUE_CALLTYPE operator<(const String& string1, StringRef string2) noexcept;
