...
public:
    ...
    */
    ...
    /** Chooses a filename relative to this one that doesn't already exist.
        ...
        @param putNumbersInBrackets     if true, this will create filenames in the
                                        ...
                                        brackets out.
    */
    File getNonexistentChildFile(const String& prefix, const String& suffix,
    ...
    */
    ...
    /** Searches this directory for files matching a wildcard pattern.
        ...
        @param whatToLookFor            a value from the TypesOfFileToFind enum, specifying whether
       to return files, directories, or both. If the ignoreHiddenFiles flag is also added to this
       value, hidden files won't be returned
