...
/**
    ...
    @tags{Core}
*/
class GLUE_API CriticalSection
{
public:
    //==============================================================================
...
private:
    ...
    GLUE_DECLARE_NON_COPYABLE(CriticalSection)
};
...
/**
    ...
    @tags{Core}
*/
class GLUE_API DummyCriticalSection
{
public:
...
private:
    GLUE_DECLARE_NON_COPYABLE(DummyCriticalSection)
};
...
/**
    ...
    struct MyObject
    {
        ...
        void foo()
        {
            ...
            {
                // If we get here, then our attempt at locking failed because another thread had
   already locked it..
            }
        }
    };
