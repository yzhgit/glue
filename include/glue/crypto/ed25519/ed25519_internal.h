...
inline void redc_mul(int64_t &s1, int64_t &s2, int64_t &s3, int64_t &s4,
                     int64_t &s5, int64_t &s6, int64_t &X) {
    s1 += X * 666643;
    s2 += X * 470296;
    s3 += X * 654183;
    s4 -= X * 997805;
...
void ge_double_scalarmult_vartime(uint8_t out[32], const uint8_t a[],
