...
class ImagePreprocess {
  public:
     ...
     */
    ImagePreprocess(ImageFormat srcFormat, ImageFormat dstFormat,
                    TransParam param);
    ...
    */
    void image_resize(const uint8_t *src, uint8_t *dst, ImageFormat srcFormat,
     ...
     */
    void image_rotate(const uint8_t *src, uint8_t *dst, ImageFormat srcFormat,
     ...
     */
    void image_flip(const uint8_t *src, uint8_t *dst, ImageFormat srcFormat,
     ...
     */
    void image_to_tensor(const uint8_t *src, Tensor *dstTensor,
                         LayoutType layout, float *means, float *scales);
     ...
     * param dst: output image data
     */
    void image_crop(const uint8_t *src, uint8_t *dst, ImageFormat srcFormat,
                    int srcw, int srch, int left_x, int left_y, int dstw,
                    int dsth);
