...
#include "glue/base/ASCII.h"
#include "glue/base/UTF16.h"
#include "glue/base/UTF32.h"
#include "glue/base/UTF8.h"
...
public:
    ...
    */
    ...
    /** Creates a string from a zero-terminated ascii text string.
        ...
        String (UTF8 ("my utf8 string..")). It's *highly* recommended that you
    ...
    */
    ...
    /** Creates a string from a UTF-8 character string */
    String(UTF8 text, size_t maxChars);

    /** Creates a string from a UTF-8 character string */
    String(UTF8 start, UTF8 end);
    ...
    /** Creates a string from a UTF-16 character string */
    String(UTF16 text, size_t maxChars);

    /** Creates a string from a UTF-16 character string */
    String(UTF16 start, UTF16 end);
    ...
    /** Creates a string from a UTF-32 character string */
    String(UTF32 text, size_t maxChars);

    /** Creates a string from a UTF-32 character string */
    String(UTF32 start, UTF32 end);
    ...
    static String charToString(glue_wchar character);
    ...
    /** This is the character encoding type used internally to store the string.
        ...
        By setting the value of GLUE_STRING_UTF_TYPE to 8, 16, or 32, you can change the
        ...
        the required index. UTF-32 provides instant random access to its characters, but uses 4
       bytes per character to store them. UTF-16 uses more space than UTF-8 and is also slow to
       index, but is the native wchar_t format used in Windows.
    ...
    */
#if (GLUE_STRING_UTF_TYPE == 32)
    using CharPointerType = UTF32;
#elif (GLUE_STRING_UTF_TYPE == 16)
    using CharPointerType = UTF16;
#elif (DOXYGEN || GLUE_STRING_UTF_TYPE == 8)
    using CharPointerType = UTF8;
#else
    #error "You must set the value of GLUE_STRING_UTF_TYPE to be either 8, 16, or 32!"
#endif
    ...
    /** Appends a character at the end of this string. */
    String& operator+=(glue_wchar characterToAppend);
#endif
    ...
    */
    ...
    /** Tests whether the string begins with a particular character.
        ...
        Uses a case-sensitive comparison.
    */
    bool startsWithChar(glue_wchar character) const noexcept;
    ...
    */
    ...
    /** Tests whether the string ends with a particular character.
        ...
        Uses a case-sensitive comparison.
    */
    bool endsWithChar(glue_wchar character) const noexcept;
    ...
    */
    ...
    /** Tests whether the string contains a particular character.
        Uses a case-sensitive comparison.
    */
    bool containsChar(glue_wchar character) const noexcept;
    ...
    */
    int indexOfChar(glue_wchar characterToLookFor) const noexcept;
    ...
    /** Searches for a character inside this string.
        ...
        @returns            the index of the first occurrence of the character in this
                            string, or -1 if it's not found.
    */
    int indexOfChar(int startIndex, glue_wchar characterToLookFor) const noexcept;
    ...
    */
    int indexOfAnyOf(StringRef charactersToLookFor, int startIndex = 0,
    ...
    */
    ...
    /** Searches for a substring within this string.
        ...
        @returns                the index of the first occurrence of this substring, or -1 if it's
       not found. If textToLookFor is an empty string, this will always return -1.
    */
    ...
    */
    ...
    /** Searches for a character inside this string (working backwards from the end of the string).
        Uses a case-sensitive comparison.
        @returns    the index of the last occurrence of the character in this string, or -1 if it's
       not found.
    */
    int lastIndexOfChar(glue_wchar character) const noexcept;

    /** Searches for a substring inside this string (working backwards from the end of the string).
        Uses a case-sensitive comparison.
        @returns    the index of the start of the last occurrence of the substring within this
       string, or -1 if it's not found. If textToLookFor is an empty string, this will always return
       -1.
    */
    ...
    */
    ...
    /** Returns the character at this index in the string.
        ...
        method may execute in either O(1) or O(n) time, so be careful when using it in your
       algorithms. If you're scanning through a string to inspect its characters, you should never
       use this operator for random access, it's far more efficient to call getCharPointer() to
       return a pointer, and then to use that to iterate the string.
        @see getCharPointer
    */
    glue_wchar operator[](int index) const noexcept;

    /** Returns the final character of the string.
        If the string is empty this will return 0.
    */
    glue_wchar getLastCharacter() const noexcept;
    ...
    */
    ...
    /** Returns a section of the string, starting from a given position.
        ...
        @see dropLastCharacters, getLastCharacters, fromFirstOccurrenceOf, upToFirstOccurrenceOf,
    ...
    */
    ...
    /** Returns a version of this string with a number of characters removed
        ...
        @see substring, fromFirstOccurrenceOf, upToFirstOccurrenceOf, fromLastOccurrenceOf,
       getLastCharacter
    */
    ...
    */
    String fromFirstOccurrenceOf(StringRef substringToStartFrom, bool includeSubStringInResult,
    ...
    */
    String fromLastOccurrenceOf(StringRef substringToFind, bool includeSubStringInResult,
                                bool ignoreCase) const;
    ...
    */
    String upToFirstOccurrenceOf(StringRef substringToEndWith, bool includeSubStringInResult,
                                 bool ignoreCase) const;

    /** Returns the start of this string, up to the last occurrence of a substring.

        Similar to upToFirstOccurrenceOf(), but this finds the last occurrence rather than the
       first. If the substring isn't found, this will return the whole of the original string.

        @see upToFirstOccurrenceOf, fromFirstOccurrenceOf
    */
    String upToLastOccurrenceOf(StringRef substringToFind, bool includeSubStringInResult,
                                bool ignoreCase) const;
    ...
    */
    ...
    /** Replaces a sub-section of the string with another string.
        ...
        @param startIndex               the first character to remove. If this is beyond the bounds
       of the string, it will be constrained to a valid range.
        @param numCharactersToReplace   the number of characters to remove. If zero or less, no
                                        characters will be taken out.
        @param stringToInsert           the new string to insert at startIndex after the characters
       have been removed.
    */
    String replaceSection(int startIndex, int numCharactersToReplace,
    ...
    /** Replaces all occurrences of a substring with another string.
        ...
        Note that this is a const method, and won't alter the string itself.
    */
    String replace(StringRef stringToReplace, StringRef stringToInsertInstead,
    ...
    /** Replaces the first occurrence of a substring with another string.
        ...
        Note that this is a const method, and won't alter the string itself.
    */
    String replaceFirstOccurrenceOf(StringRef stringToReplace, StringRef stringToInsertInstead,
                                    bool ignoreCase = false) const;

    /** Returns a string with all occurrences of a character replaced with a different one. */
    String replaceCharacter(glue_wchar characterToReplace,
                            glue_wchar characterToInsertInstead) const;
    ...
    */
    ...
    /** Returns a section from the start of the string that only contains a certain set of
       characters.
    ...
    */
    ...
    /** Checks whether the string might be in quotation marks.
        ...
        @returns    true if the string begins with a quote character (either a double or single
       quote). It is also true if there is whitespace before the quote, but it doesn't check the end
       of the string.
        @see unquoted, quoted
    */
    ...
    */
    String quoted(glue_wchar quoteCharacter = '"') const;
    ...
    */
    String paddedLeft(glue_wchar padCharacter, int minimumLength) const;

    /** Returns a copy of this string with the specified character repeatedly added to its
        end until the total length is at least the minimum length specified.
    */
    String paddedRight(glue_wchar padCharacter, int minimumLength) const;
    ...
    */
    ...
    /** Returns an iterator pointing at the terminating null of the string.
        ...
        std::for_each (str.begin(), str.end(), [] (glue_wchar c) { DBG (c); });
...
#ifndef DOXYGEN
    // Automatically creating a String from a bool opens up lots of nasty type conversion edge
    // cases. If you want a String representation of a bool you can cast the bool to an int first.
                                                        ...
                                                        int numberOfSignificantFigures)
    {
        ...
        if (number == 0)
        {
            if (numberOfSignificantFigures > 1)
            {
                ...
                for (int i = 2; i < numberOfSignificantFigures; ++i) result += "0";
    ...
    */
    ...
    /** Returns a pointer to a UTF-8 version of this string.
        ...
        UTF8::getBytesRequiredFor (myString.getCharPointer())
    ...
    */
    ...
    /** Returns a pointer to a UTF-16 version of this string.
        ...
        UTF16::getBytesRequiredFor (myString.getCharPointer())
    ...
    */
    ...
    /** Copies the string to a buffer as UTF-8 characters.
        ...
        @param destBuffer       the place to copy it to; if this is a null pointer, the method just
                                returns the number of bytes required (including the terminating null
       character).
        @param maxBufferSizeBytes  the size of the destination buffer, in bytes. If the string won't
       fit, it'll put in as many as it can while still allowing for a terminating null char at the
                                end, and will return the number of bytes that were actually used.
        @see UTF8::writeWithDestByteLimit
    */
    size_t copyToUTF8(UTF8::CharType* destBuffer, size_t maxBufferSizeBytes) const noexcept;
    ...
    /** Copies the string to a buffer as UTF-16 characters.
       ...
       fit, it'll put in as many as it can while still allowing for a terminating null char at the
        ...
        @see UTF16::writeWithDestByteLimit
    */
    size_t copyToUTF16(UTF16::CharType* destBuffer, size_t maxBufferSizeBytes) const noexcept;
    ...
    /** Copies the string to a buffer as UTF-32 characters.
        ...
        UTF32::getBytesRequiredFor (myString.getCharPointer())
       ...
       fit, it'll put in as many as it can while still allowing for a terminating null char at the
        ...
        @see UTF32::writeWithDestByteLimit
    */
    size_t copyToUTF32(UTF32::CharType* destBuffer, size_t maxBufferSizeBytes) const noexcept;
...
private:
    ...
    explicit String(
        const PreallocationBytes&); // This constructor preallocates a certain amount of memory
    ...
    {
        return createHex(
            static_cast<typename TypeHelpers::UnsignedTypeWithSize<(int) sizeof(n)>::type>(n));
    }
};

//==============================================================================
/** Concatenates two strings. */
GLUE_API String GLUE_CALLTYPE operator+(const char* string1, const String& string2);
/** Concatenates two strings. */
GLUE_API String GLUE_CALLTYPE operator+(const wchar_t* string1, const String& string2);
/** Concatenates two strings. */
GLUE_API String GLUE_CALLTYPE operator+(char string1, const String& string2);
/** Concatenates two strings. */
GLUE_API String GLUE_CALLTYPE operator+(wchar_t string1, const String& string2);
#if !GLUE_NATIVE_WCHAR_IS_UTF32
/** Concatenates two strings. */
GLUE_API String GLUE_CALLTYPE operator+(glue_wchar string1, const String& string2);
#endif

/** Concatenates two strings. */
GLUE_API String GLUE_CALLTYPE operator+(String string1, const String& string2);
/** Concatenates two strings. */
GLUE_API String GLUE_CALLTYPE operator+(String string1, const char* string2);
/** Concatenates two strings. */
GLUE_API String GLUE_CALLTYPE operator+(String string1, const wchar_t* string2);
/** Concatenates two strings. */
GLUE_API String GLUE_CALLTYPE operator+(String string1, const std::string& string2);
/** Concatenates two strings. */
GLUE_API String GLUE_CALLTYPE operator+(String string1, char characterToAppend);
/** Concatenates two strings. */
GLUE_API String GLUE_CALLTYPE operator+(String string1, wchar_t characterToAppend);
#if !GLUE_NATIVE_WCHAR_IS_UTF32
/** Concatenates two strings. */
GLUE_API String GLUE_CALLTYPE operator+(String string1, glue_wchar characterToAppend);
#endif
...
GLUE_API String& GLUE_CALLTYPE operator<<(String& string1, const String& string2);
/** Appends a string to the end of the first one. */
GLUE_API String& GLUE_CALLTYPE operator<<(String& string1, StringRef string2);
/** Appends a string to the end of the first one. */
GLUE_API String& GLUE_CALLTYPE operator<<(String& string1, const std::string& string2);

/** Appends a decimal number to the end of a string. */
GLUE_API String& GLUE_CALLTYPE operator<<(String& string1, uint8 number);
/** Appends a decimal number to the end of a string. */
GLUE_API String& GLUE_CALLTYPE operator<<(String& string1, short number);
/** Appends a decimal number to the end of a string. */
GLUE_API String& GLUE_CALLTYPE operator<<(String& string1, int number);
/** Appends a decimal number to the end of a string. */
GLUE_API String& GLUE_CALLTYPE operator<<(String& string1, long number);
/** Appends a decimal number to the end of a string. */
GLUE_API String& GLUE_CALLTYPE operator<<(String& string1, unsigned long number);
/** Appends a decimal number to the end of a string. */
GLUE_API String& GLUE_CALLTYPE operator<<(String& string1, int64 number);
/** Appends a decimal number to the end of a string. */
GLUE_API String& GLUE_CALLTYPE operator<<(String& string1, uint64 number);
/** Appends a decimal number to the end of a string. */
GLUE_API String& GLUE_CALLTYPE operator<<(String& string1, float number);
/** Appends a decimal number to the end of a string. */
GLUE_API String& GLUE_CALLTYPE operator<<(String& string1, double number);
...
String& GLUE_CALLTYPE operator<<(String&, bool) = delete;
#endif

//==============================================================================
/** Case-sensitive comparison of two strings. */
GLUE_API bool GLUE_CALLTYPE operator==(const String& string1, const String& string2) noexcept;
/** Case-sensitive comparison of two strings. */
GLUE_API bool GLUE_CALLTYPE operator==(const String& string1, const char* string2) noexcept;
/** Case-sensitive comparison of two strings. */
GLUE_API bool GLUE_CALLTYPE operator==(const String& string1, const wchar_t* string2) noexcept;
/** Case-sensitive comparison of two strings. */
GLUE_API bool GLUE_CALLTYPE operator==(const String& string1, UTF8 string2) noexcept;
/** Case-sensitive comparison of two strings. */
GLUE_API bool GLUE_CALLTYPE operator==(const String& string1, UTF16 string2) noexcept;
/** Case-sensitive comparison of two strings. */
GLUE_API bool GLUE_CALLTYPE operator==(const String& string1, UTF32 string2) noexcept;
...
//==============================================================================
/** This operator allows you to write a glue String directly to std output streams.
    This is handy for writing strings to std::cout, std::cerr, etc.
*/
template <class traits>
std::basic_ostream<char, traits>& GLUE_CALLTYPE operator<<(std::basic_ostream<char, traits>& stream,
...
*/
template <class traits>
std::basic_ostream<wchar_t, traits>& GLUE_CALLTYPE
operator<<(std::basic_ostream<wchar_t, traits>& stream, const String& stringToWrite)
{
...
{
template <>
struct hash<glue::String>
{
    size_t operator()(const glue::String& s) const noexcept { return s.hash(); }
};
} // namespace std
