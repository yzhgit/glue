...
#include "glue/base/Array.h"
#include "glue/base/LeakedObjectDetector.h"
#include "glue/base/StringRef.h"
...
public:
    ...
    */
    ...
    void addArray(Iterator&& start, Iterator&& end)
    {
        ...
        while (start != end) strings.add(*start++);
    }
    ...
    */
    ...
    /** Returns an array containing the tokens in a given string.
        ...
        @see addTokens
    */
    static StringArray fromTokens(StringRef stringToTokenise, StringRef breakCharacters,
    ...
    */
    ...
    /** Adds numbers to the strings in the array, to make each string unique.
        ...
        @param preNumberString              when adding a number, this string is added before the
       number. If you pass nullptr, a default string will be used, which adds brackets around the
       number.
        @param postNumberString             this string is appended after any numbers that are
       added. If you pass nullptr, a default string will be used, which adds brackets around the
       number.
    */
    void appendNumbersToDuplicates(bool ignoreCaseWhenComparing, bool appendNumberToFirstInstance,
                                   UTF8 preNumberString = UTF8(nullptr),
                                   UTF8 postNumberString = UTF8(nullptr));
    ...
    */
    String joinIntoString(StringRef separatorString, int startIndex = 0,
...
private:
    GLUE_LEAK_DETECTOR(StringArray)
};
