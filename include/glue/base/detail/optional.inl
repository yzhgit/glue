...
template <typename T>
template <typename U,
          std::enable_if_t<glue::detail::optional_is_copy_convertible<T, U>::value &&
...
template <typename T>
template <typename U,
          std::enable_if_t<glue::detail::optional_is_move_convertible<T, U>::value &&
...
inline constexpr glue::optional<T>::optional(in_place_t,
...
template <typename T>
template <typename U,
          std::enable_if_t<glue::detail::optional_is_value_convertible<T, U>::value &&
                           std::is_convertible<U&&, T>::value>*>
...
template <typename T>
inline constexpr const typename glue::optional<T>::value_type* glue::optional<T>::operator->()
    const noexcept {
    GLUE_ASSERT_MSG(has_value(), "optional must be engaged!");
...
glue::optional<T>::operator*() && noexcept {
    GLUE_ASSERT_MSG(has_value(), "optional must be engaged!");
...
template <typename T>
template <typename U>
inline constexpr typename glue::optional<T>::value_type glue::optional<T>::value_or(
...
inline constexpr glue::optional<T> glue::make_optional(std::initializer_list<U> il,
                                                       Args&&... args) {
    return optional<T>(
        in_place, std::forward<std::initializer_list<U>>(il), std::forward<Args>(args)...);
}
