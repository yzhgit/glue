...
/** Config: GLUE_LOG_ASSERTIONS
   ...
   disabled, however, the jassert and jassertfalse macros will not be compiled
   in a release build.
...
/** Config: GLUE_CHECK_MEMORY_LEAKS
    ...
    Enables a memory-leak check for certain objects when the app terminates. See
   the LeakedDetector class and the GLUE_LEAK_DETECTOR macro for more details
   about enabling leak checking for specific classes.
*/
